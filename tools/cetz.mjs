/* the cetz layer against several CeTZ versions.
   ...
   that lands a hair off shows up as a few hundred pixels.
...
/* which versions: the ones named on the command line, else `tested` from the
   package, resolved against what is installed. A minor is a range, and its
   newest patch is the one worth checking. */
