...
/// the runtime work it out from this page's address, which the runtime knows
/// and the document does not.
///
/// `modes` carries the desk and overview buttons, which decide what is on the
/// screen, and the button that opens the speaker view. A speaker view's
