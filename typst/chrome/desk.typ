...
/// cell's, and the cell only acts as a box if something in it is one. This
/// element is that box.
...
/// The current page's speaker notes, under the deck at the desk. It is left
/// empty, and the runtime fills it from the page the deck is on.
