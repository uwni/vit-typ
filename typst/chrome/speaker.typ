...
/// nothing here is rendered twice. The two previews behave differently, and
/// each says which one it is in its `name`.
///
/// `main` is a mirror: it plays the page change out, because it is the one
/// place the presenter can see the audience's screen. Because it is a copy of
/// this document, its drawings stay in step with theirs. `aside` runs
